...
<head>
  ...
  <link href="../css/alphaville.css" rel="stylesheet">
  <link href="../css/magnific.popup.css" rel="stylesheet">
  <link href="../boostrap/bootstrap.min.css" rel="stylesheet">
  <title>site arquitetura </title>
</head>
    ...
    <div class="container text-center ">
      ...
      <div class="collapse navbar-collapse d-lg-flex justify-content-end" id="navbarNav">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../residencias.php">residenciais</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../comerciais.php">comerciais</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../contatos/contatos-formulario-inserir.php">contato</a>
          </li>
          <li class="nav-item">
